    ...
    >
      <Flex w="100%" px="6" py="5" align="center" justify="space-between">
        ...
        {i18n.language == 'en' && <button  onClick={()=>{
            ...
            <Heading className="lang" color="blueTheme.navLinkActive" fontWeight="extrabold" fontSize="1.3rem">FR</Heading>
            </button>}
           {i18n.language == 'fr' &&  <button onClick={()=>{
            i18n.changeLanguage('en')
           }}>
            {/* <Icon as={TbMessageLanguage} width="25px" height="25px" /> */}
            <Heading  className="lang" color="blueTheme.navLinkActive" fontWeight="extrabold" fontSize="1.3rem">EN</Heading></button>}
        <HStack>
